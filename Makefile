...
UNREALROOTPATH = /home/mingle/ue4/UnrealEngine
GAMEPROJECTFILE =/home/mingle/git/FPSProject/FPSProject.uproject
...
FPSProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) FPSProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) FPSProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) FPSProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSProjectEditor-Linux-Test:
	 $(PROJECTBUILD) FPSProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FPSProjectEditor:
	 $(PROJECTBUILD) FPSProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
